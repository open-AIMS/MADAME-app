...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    defineCalciteElements(window, { resourcesUrl: "https://js.arcgis.com/calcite-components/2.11.1/assets" });

    // should only be called once
    // https://developers.arcgis.com/javascript/latest/get-started-angular/
    // works, but maybe better to put in provider/module
    defineArcgisMapElements(window, { resourcesUrl: "https://js.arcgis.com/map-components/4.30/assets" });
  }
